...
namespace Biblioteca.Controllers
{
    public class PersonasController : Controller
    {
        ...
        public PersonasController(BiblioDatabaseContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPersona,Nombre,Apellido,Correo,Clave")] Persona persona)
        {
